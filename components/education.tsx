...
import EducationIcon01 from '@/public/images/education-icon-01.png'
    ...
    <div className="space-y-8">
      ...
      <ul className="space-y-8">
        ...
        <li className="relative group">
          <div className="flex items-start before:absolute before:left-0 before:h-full before:w-px before:bg-slate-200 before:dark:bg-slate-800 before:self-start before:ml-[28px] before:-translate-x-1/2 before:translate-y-8 before:group-last-of-type:hidden">
            ...
            <div className="pl-20 space-y-1">
              <div className="text-xs text-slate-500 uppercase">Aug 2017 <span className="text-slate-400 dark:text-slate-600">·</span> May 2021</div>
        ...
        <li className="relative group">
          <div className="flex items-start before:absolute before:left-0 before:h-full before:w-px before:bg-slate-200 before:dark:bg-slate-800 before:self-start before:ml-[28px] before:-translate-x-1/2 before:translate-y-8 before:group-last-of-type:hidden">
            <div className="absolute left-0 h-14 w-14 flex items-center justify-center border border-slate-200 dark:border-slate-800 dark:bg-gradient-to-t dark:from-slate-800 dark:to-slate-800/30 bg-white dark:bg-slate-900 rounded-full">
              <Image src={EducationIcon01} width={28} height={26} alt="San Jose State UniversitySan Jose State University" />
            </div>
            <div className="pl-20 space-y-1">
              <div className="text-xs text-slate-500 uppercase">Aug 2017 <span className="text-slate-400 dark:text-slate-600">·</span>May 2021</div>
              <div className="font-aspekta font-[650] text-slate-800 dark:text-slate-100">Bachelor of Technology</div>
              <div className="text-sm font-medium text-slate-800 dark:text-slate-100">Delhi Technological University</div>
              <div className="text-sm text-slate-500 dark:text-slate-400">Throughout my years at DTU, I immersed myself in a dynamic learning environment, surrounded by dedicated faculty and talented peers.</div>
            </div>
          </div>
        </li>
      </ul>
